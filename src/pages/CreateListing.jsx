...
const CreateListing = () => {
    ...
    /* UPLOAD , DRAG , DROP AND UPDATE PHOTOS*/
    ...
    const handlePost = async (e) => {
        e.preventDefault();
        try {
            /* CREATE NEW FORM DATA OBJECT TO HANDLE FILE UPLOAD  */
            ...
            /* APPEND THE PHOTOS - APPEND EACH SELECTED PHOTOS TO FORM DATA OBJECT  */
            ...
            <div className='create-listing'>
                ...
                <form onSubmit={handlePost}>
                    ...
                    <div className='create-listing_step2'>
                        ...
                        <hr />
                        <h3>Tell your guests what you have to offer</h3>
